function [ X, slack, hist ] = complementEstADMM( illRef, ambientWghts, leds, cameraMat, alpha, beta, varargin )
...
for i=1:inputs.maxIter
    ...
    % X update using cg
    t2 = tic;
    Atb = applyAt(ambientCam,Z1-U1,Z2-U2,h,w,illRefCam,cameraMat'*leds, beta, hist.rho(i)/2);
...
function res = applyAt( ambientCam, spatialSmooth, nonnegativity, h, w, illRefCam, cameraMatTleds, beta, rho)
